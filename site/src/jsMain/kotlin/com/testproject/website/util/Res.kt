package com.testproject.website.util
...
object Res {
    ...
    object String {
        const val NAME = "Alexander Krivonogov"
            const val PROFESSION = "Sanechka"
        const val ABOUT_ME =
            "I want to be in a team for a project with my beloved headman, when I laugh, these sounds can be confused with the death throes and I like to pronounce the phrase, steam train tyr tyr tyr"
        const val BUTTON_TEXT = "Get in touch"
        const val ROBOTO_CONDENSED = "RobotoCondensedBold"
        const val ROBOTO_REGULAR = "RobotoRegular"
        const val MY_EMAIL = "macgregorking2020@gmail.com"
